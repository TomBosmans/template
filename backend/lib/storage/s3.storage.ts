...
export default class S3Storage implements ObjectStorage {
  ...
  public async applyPolicy(policy: ObjectStoragePolicy) {
    await S3Storage.client.send(
    ...
    this.logger.info("Applied policy", { bucket: this.bucket, policy })
  }
